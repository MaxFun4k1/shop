...
export class StatisticsService {
  ...
  private async calculateAverageRaiting(storeId: string) {
    const averageRaiting = await this.prisma.review.aggregate({
      where: { storeId },
      _avg: { rating: true }
    });

    return averageRaiting._avg.rating;
  }
